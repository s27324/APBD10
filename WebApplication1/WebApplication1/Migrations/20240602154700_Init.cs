    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Prescription_pl", x => x.IdPrescription);
                    table.ForeignKey(
                        name: "Prescription_Dcotor",
                        column: x => x.IdDoctor,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "kacper.alot1602@gmail.com", "Kacper", "Alot" },
                    { 2, "koryncki@gmail.com", "Dominik", "Koryncki" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(1990, 9, 5), "Kamil", "Pilarczyk" },
                    { 2, new DateOnly(1970, 5, 19), "Jerzy", "Niewolnik" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2023, 9, 10), new DateOnly(2023, 10, 10), 1, 1 },
                    { 2, new DateOnly(2024, 6, 1), new DateOnly(2024, 7, 11), 2, 2 }
                });
